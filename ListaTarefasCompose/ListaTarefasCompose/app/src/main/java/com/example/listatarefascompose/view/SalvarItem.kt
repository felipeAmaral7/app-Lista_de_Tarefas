...
@Composable
fun SalvarItem(navController: NavController){
    // Conteúdo da tela de salvar item

    Scaffold( // Adicionado Scaffold
        topBar = { // Adicionado TopAppBar
            TopAppBar(
        ...
        var titulodatarefa by remember { //estado: titulo da tarefa
            mutableStateOf("")
        }
        ...
        Column(
            ...
            CaixadeTexto(  //so assim pra caixa título aparecer na tela
